/**
 * AI Chat Service
 * Maps user symptoms to medical departments using keyword detection
 */
...
const SYMPTOM_MAP = [
    {
        ...
        urgency: 'CRITICAL',
        message: '🚨 This sounds like a medical emergency. Please call 108 immediately or go to the nearest Emergency department.',
    },
    {
        ...
        urgency: 'HIGH',
        message: '❤️ Your symptoms suggest a potential cardiac issue. You should consult a Cardiologist promptly.',
    },
    {
    ...
    },
    {
        ...
        urgency: 'MEDIUM',
        message: '👁️ Your symptoms are related to vision or eye health. An Ophthalmologist should evaluate you.',
    },
    {
        department: 'ENT',
...
/**
 * Analyze symptoms text and return department + response
 */
function analyzeSymptomsAI(userInput) {
    ...
    if (!bestMatch || highestScore === 0) {
        return {
            reply: `I couldn't match specific symptoms, but I recommend starting with a General Physician for a full evaluation. Please describe your symptoms in more detail for a better recommendation.`,
            department: 'General',
            urgency: 'LOW',
            confidence: 'low',
        };
    ...
    return {
        ...
        disclaimer: '⚠️ This is an AI-assisted suggestion and not a medical diagnosis. Please consult a qualified doctor for professional advice.',
    };
}
